...
-- Global include directory for project
add_includedirs(".")
...
target("TraderOES")
    ...
    add_deps("WTSUtils", "WTSTools")
    add_includedirs("$(projectdir)/src/API/oesApi0.17.5.8/include")
    add_linkdirs("$(projectdir)/src/API/oesApi0.17.5.8/linux")
...
target("TestDtPorter")
    ...
    add_includedirs("../WtDtPorter/include")
    add_includedirs("../WtDtHelper/include")
